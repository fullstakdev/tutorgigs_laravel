...
<!--                <div>
                    ...
                    <div id="schoolAttendanceRate" class="alert alert-warning"><?php echo mysql_num_rows($resultLS);?> Session Clases Found</div>                    
                </div>   -->
                <hr>
                <div>                   
...
<script>        
    ...
    var getSchoolSessions = (schoolID) => {
        ...
        $.ajax({
            ...
            url:'school_attendance_ajax.php',
            success:function(data) {    
                let result_sessions = data;     
                if (result_sessions) {    
                    
                    $("#sessionResults").html(result_sessions);
