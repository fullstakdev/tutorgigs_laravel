...
<html lang="en">
	...
	<head><base href="">
		<meta charset="utf-8" />
		<title>Tutorgigs | Admin Panel </title>
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
		...
		<div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
			<!--begin::Logo-->
			<a href="index.html">
				<img alt="Logo" src="{{asset('assets_old/img/logo.png')}}" />
			</a>
			<!--end::Logo-->
			<!--begin::Toolbar-->
				...
				<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
					...
					<div class="brand flex-column-auto" id="kt_brand">
						...
						<a href="index.html" class="brand-logo">
                                                    <img alt="Logo" src="{{asset('assets_old/img/logo.png')}}" style="width:150px" />
						</a>
						<!--end::Logo-->
						<!--begin::Toggle-->
							...
							<ul class="menu-nav">
								<li class="menu-item menu-item-active" aria-haspopup="true">
									<a href="index.html" class="menu-link">
										<i class="fab fa-delicious" style="margin-top: 5px;margin-right: 15px"></i>
								...
								<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
									<a href="javascript:;" class="menu-link menu-toggle">
                                                                            <i class="fas fa-users " style="margin-top: 5px;margin-right: 15px"></i>
									...
									<div class="menu-submenu">
													...
													<ul class="menu-subnav">
														<li class="menu-item" aria-haspopup="true">
                                                                                                                    <a href="{{url('tutor_list')}}" class="menu-link">
														...
														<li class="menu-item" aria-haspopup="true">
															<a href="{{url('add_tutor')}}" class="menu-link">
																<i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
																<span class="menu-text">Add Tutor</span>
															</a>
														</li>
								...
								<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
									<a href="javascript:;" class="menu-link menu-toggle">
									 <i class="fab fa-buffer" style="margin-top: 5px;margin-right: 15px"></i>
									...
									<div class="menu-submenu">
										...
										<ul class="menu-subnav">
											...
											<li class="menu-item" aria-haspopup="true">
												<a href="{{url('tutor_session_list')}}" class="menu-link">
													<i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
													<span class="menu-text">List of Tutor Sessions</span>
												</a>
											</li>
                                                                                        <li class="menu-item" aria-haspopup="true">
												<a href="{{route('cancelled_sessions')}}" class="menu-link">
													<i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
													<span class="menu-text">Cancelled Sessions History</span>
												</a>
											</li>
                                                                                        <li class="menu-item" aria-haspopup="true">
												<a href="{{route('booked_unbooked_sessions')}}" class="menu-link">
													<i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
													<span class="menu-text">Booked/Unbooked Sessions</span>
												</a>
											</li>
                                                                                        <li class="menu-item" aria-haspopup="true">
												<a href="{{route('calendar')}}" class="menu-link">
													...
													<span class="menu-text">Calendar</span>
                                                                                        ...
                                                                                        <li class="menu-item" aria-haspopup="true">
												<a href="{{route('jobs_board')}}" class="menu-link">
													<i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
													<span class="menu-text">Jobs Board</span>
												</a>
											</li>
                                                                                        
                                                                                        <li class="menu-item" aria-haspopup="true">
												<a href="{{route('suspended_sessions')}}" class="menu-link">
													<i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
													<span class="menu-text">Suspended Sessions</span>
												</a>
											</li>
                                                                                        <li class="menu-item" aria-haspopup="true">
												<a href="{{route('session_view')}}" class="menu-link">
													<i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
													<span class="menu-text">Session View(Testing)</span>
												</a>
											</li>
												...
												<a href="{{route('observer_Sessions')}}" class="menu-link">
													...
													<span class="menu-text">Observer Taken Session <span class="badge" style="background-color:red;color:#fff">5</span></span>
                                                                                                        
												</a>
											</li>
                                                                                        <li class="menu-item" aria-haspopup="true">
												<a href="{{route('session_log_history')}}" class="menu-link">
													<i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
													<span class="menu-text">Session Log History</span>
												</a>
											</li>
                                                                ...
                                                                <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
									<a href="javascript:;" class="menu-link menu-toggle">
                                                                            <i class="far fa-money-bill-alt" style="margin-top: 5px;margin-right: 15px"></i>
									...
									<div class="menu-submenu">
													...
													<ul class="menu-subnav">
														<li class="menu-item" aria-haspopup="true">
                                                                                                                    <a href="{{route('payment_history')}}" class="menu-link">
																<i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
														...
														<li class="menu-item" aria-haspopup="true">
															<a href="{{route('payment_history_paid')}}" class="menu-link">
																<i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
									...
									<a href="" class="menu-link">
										<i class="far fa-list-alt" style="margin-top: 5px;margin-right: 15px"></i>
										<span class="menu-text">Attendance Report</span>
									</a>
								</li>
                                                                 <li class="menu-item" aria-haspopup="true">
									<a href="{{route('download_survey_report')}}" class="menu-link">
										<i class="fas fa-cloud-download-alt" style="margin-top: 5px;margin-right: 15px"></i>
										<span class="menu-text">Download Survey Report</span>
									</a>
								</li>
                                                                
                                                                <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
									<a href="javascript:;" class="menu-link menu-toggle">
                                                                            <i class="flaticon-layer " style="margin-top: 5px;margin-right: 15px"></i>
										<span class="menu-text">Test Qualification</span>
										<i class="menu-arrow"></i>
									</a>
									<div class="menu-submenu">
													<i class="menu-arrow"></i>
													<ul class="menu-subnav">
														<li class="menu-item" aria-haspopup="true">
                                                                                                                    <a href="https://tutorgigs.io/test_engine" targe="_blank" class="menu-link">
																<i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
														...
														<li class="menu-item" aria-haspopup="true">
															<a href="{{route('training_management')}}" class="menu-link">
																<i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                                ...
                                                                <li class="menu-item " aria-haspopup="true">
									<a href="{{route('certification_list')}}" class="menu-link">
										<i class="flaticon-list-1" style="margin-top: 5px;margin-right: 15px"></i>
										<span class="menu-text">Certification List</span>
									</a>
								</li>
								<li class="menu-item " aria-haspopup="true">
									<a href="{{url('manage_applicant')}}" class="menu-link">
										<i class="flaticon-users" style="margin-top: 5px;margin-right: 15px"></i>
										<span class="menu-text">Manage Applicant</span>
									</a>
								</li>
								
								<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
									<a href="javascript:;" class="menu-link menu-toggle">
                                                                            <i class="flaticon-chat-1 " style="margin-top: 5px;margin-right: 15px"></i>
									...
									<div class="menu-submenu">
													...
													<ul class="menu-subnav">
														<li class="menu-item" aria-haspopup="true">
                                                                                                                    <a href="{{route('tutor_message')}}" class="menu-link">
																<i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
																<span class="menu-text">Message a Tutor</span>
															</a>
														</li>
														
														<li class="menu-item" aria-haspopup="true">
															<a href="{{route('broadcast_message')}}" class="menu-link">
																<i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
																<span class="menu-text">Broadcast a Message</span>
															</a>
														</li>
                                                                ...
                                                                <li class="menu-item " aria-haspopup="true">
									<a href="{{route('manage_admins')}}" class="menu-link">
										<i class="flaticon-users" style="margin-top: 5px;margin-right: 15px"></i>
			...
			<div class="offcanvas-content pr-5 mr-n5">
				...
				<div class="d-flex align-items-center mt-5">
					...
					<div class="d-flex flex-column">
						...
						<div class="text-muted mt-1">Tutor Admin</div>
						<div class="navi mt-2">
