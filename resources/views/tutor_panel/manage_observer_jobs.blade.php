...
@endsection
@section('content')
<?php require_once $_SERVER['DOCUMENT_ROOT'].'/MeritHub/MeritHub.Keys.php'; ?>
							...
							<div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex flex-column">
										<!--begin::Title-->
										<h2 class="text-white font-weight-bold my-2 mr-5">Manage Observer Job</h2>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
												...
												<div class="d-flex align-items-center justify-content-between flex-wrap mt-2">
													...
													<div class="my-lg-0 my-1">
                                                                                                            <div class="btn-group btn-group-lg" role="group" aria-label="Large button group">
                                                                                                                ...
                                                                                                                <a href="{{url('tutor/instructor_join_roomMerit')}}/{{$ses_det->id}}" target="_blank" class="btn btn-danger">Join as instructor</a>
													        @else
                                                                                                                    <a href="{{url('join-as-instructor')}}/{{$ses_det->id}}" target="_blank" class="btn btn-danger">Join as instructor</a>
                                                                                                                @endif 
