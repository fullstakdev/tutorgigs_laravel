							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">Jobs Board ({{$total_sessions}})</h5>
...
<div class="d-flex flex-column-fluid" style="margin-top: 2%">
										...
										<div class="d-flex">
											...
											<div class="flex-grow-1">
												...
												<div class="d-flex align-items-center justify-content-between flex-wrap mt-2">
													...
													<div class="mr-3">
														<!--begin::Name-->
														<a href="#" class="d-flex align-items-center text-dark text-hover-primary font-size-h5 font-weight-bold mr-3">{{$grade->name}} 											                                                                                                                                                                                                                               </a>
														<!--end::Name-->
														<!--begin::Contacts-->
           ...
           @if($in_sec>0){
           <a href="{{url('admin/delete_session')}}/{{$ses_det->id}}" class="btn btn-danger btn-sm">Delete</a>
           @endif
													...
													<div class="d-flex justify-content-between pt-6">
															<div class="d-flex flex-column flex-root">
																<span class="font-weight-bolder">Assign Tutor</span>
                                                                                                                                    ...
                                                                                                                                    <span class="opacity-70">  {{@$tutor->f_name}}&nbsp;{{@$tutor->lname}}
                                                                                                                                        </span> <strong><a href="javascript:void(0);"  style="text-decoration:underline;">Reassign Tutor</a> </strong>
                                                                                                                                     @else
                                                                                                                                       <span class="opacity-70">  {{@$tutor->f_name}}&nbsp;{{@$tutor->lname}}
                                                                                                                                        </span> <strong><a href="javascript:void(0);"  style="text-decoration:underline;">Assign Tutor</a> </strong>
                                                                                                                                    @endif
