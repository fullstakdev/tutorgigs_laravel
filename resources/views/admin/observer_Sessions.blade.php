							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">Observer Session List({{$total_sessions}})</h5>
										...
										<div class="d-flex">
											...
											<div class="flex-grow-1">
												...
												<div class="d-flex align-items-center justify-content-between flex-wrap mt-2">
													...
													<div class="mr-3">
														<!--begin::Name-->
														<a href="javascript:void(0)" class="d-flex align-items-center text-dark text-hover-primary font-size-h5 font-weight-bold mr-3">{{$grade->name}}      </a>														                                                                                                                                                                                                                         
														<!--end::Name-->
														<!--begin::Contacts-->
													...
													<div class="my-lg-0 my-1">
                                                                                                            ...
                                                                                                            <a href="javascript:void(0)" SessionID="<?=$ses_det->id?>" action="<?=$Sessiontype?>" class="btn btn-primary btn-sm viewSession">Session Details</a>
															...
															<div class="d-flex flex-column flex-root">
																<span class="font-weight-bolder ">Assign Tutor</span>
                                                                                                                                 @if($ses_det->tut_teacher_id > 0)
                                                                                                                                     <span class="opacity-70 font-size-sm"><i class="far fa-user"></i>&nbsp;&nbsp;<strong>{{@$tutor->f_name}}&nbsp;{{@$tutor->lname}} </strong></span>
                                                                                                                                    <span class="opacity-70"><i class="fa fa-envelope-open-text"></i>&nbsp;&nbsp;{{@$tutor->email}} </span>
                                                                                                                                    <span class="opacity-70"><i class="far fa-calendar-alt"></i>&nbsp;&nbsp;{{date('F d,Y H:iA', strtotime($ses_det->observer_taken_date))}} </span>
                                                                                                                                     @else
                                                                                                                                        - 
                                                                                                                                    @endif
															...
															<div class="d-flex flex-column  flex-root">
																<span class="font-weight-bolder">Assign Observer</span>
                                                                                                                                   @if($ses_det->add_observer == 1 && $ses_det->tut_observer_id)
                                                                                                                                      ...
                                                                                                                                      <span class="opacity-70 font-size-sm"><i class="far fa-user"></i>&nbsp;&nbsp;<strong>{{@$observer->f_name}}&nbsp;{{@$observer->lname}} </strong></span>
                                                                                                                                     <span class="opacity-70"><i class="fa fa-envelope-open-text"></i>&nbsp;&nbsp;{{@$observer->email}} </span>
                                                                                                                                     <span class="opacity-70"><i class="far fa-calendar-alt"></i>&nbsp;&nbsp;{{date('F d,Y H:iA', strtotime($ses_det->observer_taken_date))}} </span>
                                                                                                                                      @else
                                                                                                                                        - 
                                                                                                                                    @endif
